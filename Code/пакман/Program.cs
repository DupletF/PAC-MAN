...
namespace пакман
{
    internal class Program
    {
        ...
        {   
            ...
            char[,] map = ReadMap("map2", out packmanX, out packmanY,out ghostX, out ghostY, ref allDots);
            ...
            while (isPlaying)
            {
                ...
                if (Console.KeyAvailable)
                {
                    ...
                    ChangeDirection(key, ref pacmenDX, ref pacmenDY);
                }

                if (map[packmanX + pacmenDX, packmanY + pacmenDY] != '#')
                {
                    CollectDots(map, packmanX, packmanY, ref collectDots);
                   
                    Move(map, '@', ref packmanX, ref packmanY, pacmenDX, pacmenDY);
                }
        ...
        static void Move(char[,] map, char symvol, ref int X, ref int Y, int DX, int DY)
        {
